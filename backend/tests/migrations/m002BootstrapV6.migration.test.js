...
describe('M-002 bootstrap v6 reconciliation', () => {
    ...
    it('archive une référence de développement pré-v6 incomplète créée par l acteur bootstrap', async () => {
        const legacy = await createActiveProductReference({
            name: 'Ancienne référence QA Gamme 4',
            conservationType: 'FRAIS',
        });
        ...
        await ProductReferenceBootstrapRun.create({
            version: 'm002-reference-v5',
            datasetHash: 'test-historical-bootstrap-v5',
